...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
    ...
    <p> Jamur tiram merupakan salah satu jenis jamur yang banyak dijual di pasaran. Jamur ini mengandung banyak zat yang penting bagi tubuh, di antaranya serat, beta glucan, vitamin B, mineral, kalium, dan beberapa jenis karbohidrat. Jamur ini baik dikonsumsi karena bebas lemak, rendah kalori, dan bebas kolesterol.</p>
</div>
<div class="container">
    ...
    <p>Selain kolesterol darah, dalam penelitian tersebut juga menunjukan bahwa manfaat jamur tiram lainnya dapat membantu menurunkan kadar trigliserida dan gula darah pada penderita diabetes.</p>
   ...
   <img src="/images/3.jpg" width="300" height="250">
    ...
    <p>Komposisi jamur ini akan memberi peringatan dini pada Natural Killer (NK) cell, yakni sel pembunuh alami yang mampu membunuh sel kanker untuk lebih waspada dengan adanya pertumbuhan sel kanker, dan sel T yang membantu melawan infeksi yang terjadi dalam tubuh.</p>
   ...
   <img src="/images/4.jpg" width="300" height="250" >
    ...
    <p>Saat masuk ke dalam tubuh, vitamin B3 akan diubah menjadi nikotinamida adenin dinukleotida (NAD) dan nikotinamida adenin dinukleotida fosfat (NADP). Kedua senyawa ini termasuk dalam antioksidan, sehingga dapat membantu menjaga kesehatan tubuh.</p>
    ...
    <p>Penelitian yang dipublikasi dalam Journal of Medicinal Food tahun 2010 menyatakan bahwa ergothioneine bermanfaat untuk mencegah terjadinya pembentukan plak di pembuluh darah yang memicu penyakit jantung dan aterosklerosis.</p>
    <p>Lebih dari itu, antioksidan juga berfungsi menghambat penyebaran sel-sel kanker yang salah satunya juga disebabkan oleh radikal bebas.</p>
